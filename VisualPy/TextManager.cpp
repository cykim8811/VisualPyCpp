...
TextManager::TextManager(SDL_Renderer* renderer, TTF_Font* _font, int _width, int _height) {
	font = _font;
	width = _width;
	height = _height;
	printf("C");
...
void TextManager::draw_text(SDL_Renderer* renderer, int x, int y, const char* str, SDL_Color color) {
...
void TextManager::draw_char(SDL_Renderer* renderer, int x, int y, const char str, SDL_Color color) {
	int texW, texH;
